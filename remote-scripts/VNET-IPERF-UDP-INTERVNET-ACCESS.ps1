...
#region TEST EXECUTION  
		...
		$udpServer = $nfsServer
		$udfServer.cmd = "/home/test/start-server.py -u yes -p 990 -m yes"
...
#192.168.4.199
			...
			{ 
				try
				{
					...
					{
						$udpClient.nodeIperfCmd  = "./start-client.py -c $($udpServer.ip) -p 990 -t10 -u yes -l 1420"
					}

					if(($mode -eq "URL") -or ($mode -eq "Hostname"))
					{
						$udpClient.nodeIperfCmd  = "./start-client.py -c $($udpServer.hostname) -p 990 -t10 -u yes -l 1420"
					}
